...
def get_args():
    ...
    parser.add_argument('--ff_size', type=int, default=2560,
                        help='hidden size in projection network')
    parser.add_argument('--dropout_r', type=float, default=0.1)
    parser.add_argument('--layer_fusion', type=int, default=3)
    parser.add_argument('--normlayer', type=int, default=3)
    parser.add_argument('--layerforsemantic', type=int, default=1)
    parser.add_argument('--layerforspace', type=int, default=1)
    parser.add_argument('--normlayer2', type=int, default=3)
    parser.add_argument('--normlayer3', type=int, default=2)
    parser.add_argument('--pretrain_emb', type=int, default=128,
    ...
    parser.add_argument('--weight_decay_main', type=float, default=3e-4,
                        help='L2 penalty factor of the main Adam optimizer')
    parser.add_argument('--weight_decay_bert', type=float, default=3e-4,
                        help='L2 penalty factor of the main Adam optimizer')
    parser.add_argument('--weight_decay_club', type=float, default=3e-4,
                        help='L2 penalty factor of the main Adam optimizer')
